...
import { MyToken, TokenAuction, TokenAuctionWithHeap } from "../typechain-types";
// import { BigNumber } from "ethers";

describe("TokenAuction using Heap", function () {
  let auction: TokenAuctionWithHeap;
  let token: MyToken;
  let owner: any;
  let addr1: any;
  let addr2: any;
  ...
  beforeEach(async function () {
    ...
    const TokenAuction = await ethers.getContractFactory("TokenAuctionWithHeap");
